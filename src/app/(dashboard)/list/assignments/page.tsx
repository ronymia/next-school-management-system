...
import { assignmentsData } from "@/libs/data";
...
export default function AssignmentListPage() {
  ...
  const handleEdit = (item: TAssignment) => {
    console.log("Edit", item);
  };

  const handleDelete = (item: TAssignment) => {
    console.log("Delete", item);
  };

  const columns: Column<TAssignment>[] = useMemo(
    () => [
      // subject
      {
        header: "Subject",
        ...
        actions: [
          {
            ...
            handler: handleEdit,
            getVisibility: (item: TAssignment) => true,
            getRenderCell: (item: TAssignment) => (
