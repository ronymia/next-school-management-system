        ...
        <div className="flex flex-col xl:flex-row gap-4">
          ...
          <div className="bg-sky rounded-md py-6 px-4 flex-1 flex  gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <h1 className="text-xl font-semibold">MD Rony Khan</h1>
          ...
          <div className="flex-1 flex flex-wrap items-center gap-4">
            ...
            >
              ...
              />
              <div className="">
                <h1 className="text-xl text-semibold">6th</h1>
                <span className=" text-xs text-gray5-500">Grade</span>
              </div>
            </div>
            {/* Card */}
            <div
            ...
            >
              ...
              />
              <div className="">
                <h1 className="text-xl text-semibold">18</h1>
            ...
            >
              ...
              />
              <div className="">
                <h1 className="text-xl text-semibold">6A</h1>
                <span className=" text-xs text-gray5-500">Classes</span>
              </div>
            </div>
          </div>
        </div>
